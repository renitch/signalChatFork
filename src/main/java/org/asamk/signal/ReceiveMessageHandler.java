...
public class ReceiveMessageHandler implements Manager.ReceiveMessageHandler {
    ...
    private void processData(MessageEnvelope envelope) {
        ...
        if (envelope.data().isPresent() && 
            envelope.data().get().groupContext().isPresent()) {
            	
            	GroupId groupId = envelope.data().get().groupContext().get().groupId();
            	var group = m.getGroup(groupId);

            	String groupName = "";
            	String message = "";
            	String formattedDate = new java.text.SimpleDateFormat("dd/MM/yyyy HH:mm:ss").format(new java.util.Date(envelope.timestamp()));
                ...
                if (envelope.data().get().body().isPresent()) {
                	message = envelope.data().get().body().get();
