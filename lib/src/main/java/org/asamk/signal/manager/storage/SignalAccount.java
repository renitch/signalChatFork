...
import org.asamk.signal.manager.storage.incomingmessages.IncomingMessagesStore;
...
public class SignalAccount implements Closeable {
    ...
    private IncomingMessagesStore incomingMessagesStore;
    ...
    public IncomingMessagesStore getIncomingMessagesStore() {
        return getOrCreate(() -> incomingMessagesStore, () -> incomingMessagesStore = new IncomingMessagesStore(getAccountDatabase()));
    }
